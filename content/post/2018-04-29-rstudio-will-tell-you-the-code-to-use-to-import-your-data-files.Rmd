...
categories: []
---
When it comes to importing data files, such as csv's or xls's, it can be uncertain which method to use. It can also be easy to forget how to do it or the options that are available.
...
Once everything is ready to go, it's time to finish importing the dataset, including grabbing the code to use in your file or project. You can find the code preview in the lower right corner of this same window. Copy that and then click the "Import" button below that preview.
